                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        if ($order['extra_discount_type'] == 'percent') {
                            $extraDiscount = (($total_product_price) / 100) * $order['extra_discount'];
                        } else {
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-6 title-color">
                                        <strong>{{setCurrencySymbol(amount: usdToDefaultCurrency(amount:  $item_price-$discount-$extraDiscount), currencyCode: getCurrencyCode()) }}</strong>
                                    </dd>
