                                ...
                                <div class="text-wrap">
                                    ...
                                    <div class="content p-0">
                                        @if(strlen($review['comment']) > 200))
                                            ...
                                            <span id="show-more-{{$review->id}}" data-id="{{$review->id}}" class="toggle-btn">...<a href="javascript:void(0)">{{ translate('show_more') }}</a></span>
                                            <span id="show-more-content-{{$review->id}}" class="show-more-content">
                                            {{substr($review['comment'], 200)}}
                                            <span id="show-less-{{$review->id}}" data-id="{{$review->id}}" class="toggle-btn"><a href="javascript:void(0)">{{ translate('show_less') }}</a></span>
                                        @else
                                            {{ $review['comment'] }}
                                        @endif
                                    </div>
