                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    <img class="avatar avatar-60 rounded"
                                                         src="{{ getValidImage(path: 'storage/app/public/product/thumbnail/'.$productDetails->thumbnail, type: 'backend-product') }}" alt="{{translate('image_Description')}}">
                                                    <div>
                                                                ...
                                                                <div class="inputDnD">
                                                                    <div class="form-group inputDnD input_image input_image_edit"
                                                                        ...
                                                                        <input type="file" name="digital_file_after_sell"
                                                                               class="form-control-file text--primary font-weight-bold image-input" accept=".jpg, .jpeg, .png, .gif, .zip, .pdf">
                                                                    </div>
                                                                </div>
                        ...
                        @if($physicalProduct)
                            <ul class="list-unstyled list-unstyled-py-4">
                                ...
                                @if (isset($order->deliveryMan))
                                    ...
                                    <li class="choose_delivery_man">
                                        <label class="font-weight-bold title-color fz-14">{{translate('expected_delivery_date')}}</label>
                    ...
                    @if($billing)
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                ...
                                @if($order['order_status'] != 'delivered')
                                    <button class="btn btn-outline-primary btn-sm square-btn billing-address-update-modal" title="{{translate('edit')}}"
